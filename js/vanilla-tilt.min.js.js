/* 출처 https://github.com/deepeshrohilla/glass-morphism-card-3d-hover-effects
 */
...
btn.addEventListener("click", () => gb.classList.toggle("active"));
btn.addEventListener("click", () => year.classList.toggle("active"));
